...
/// Provides housing facilities data with pagination and caching.
class StockHousingFacilitiesDataNotifier extends ChangeNotifier {
  ...
  /// Creates a notifier for housing facilities data and triggers initial load.
        ...
        try {
          ...
          if (priorityResponse is Map<String, dynamic>) {
            priorityList = List<String>.from(
                priorityResponse['stock_housing_facilities']
                        as List<dynamic>? ??
                    []);
          }
        } catch (_) {}
