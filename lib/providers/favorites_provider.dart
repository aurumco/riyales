...
class FavoritesNotifier extends ChangeNotifier {
  ...
  Set<String> get favorites => _favorites; // Public getter for the favorites set
  ...
  Future<void> toggleFavorite(String assetId) async {
    ...
    try {
        final bool? hasVibrator = await Vibration.hasVibrator(); // Made bool? to align with package
        if (hasVibrator ?? false) { // Added null check
