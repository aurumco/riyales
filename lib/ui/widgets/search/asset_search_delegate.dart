    ...
    switch (currentTabIndex) {
      case 0: // Currency
        ...
        listToShow = AssetListPage<models.CurrencyAsset>(
            ...
            onInitialize: () => currencyNotifier.fetchInitialData(), // May not be strictly needed here if already loaded
      ...
      case 3: // Stock - Assuming TSE/IFB for the generic stock search for now
        final stockTseIfbNotifier = Provider.of<StockTseIfbDataNotifier>(context);
        listToShow = AssetListPage<models.StockAsset>(
            ...
            onRefresh: () => stockTseIfbNotifier.fetchInitialData(isRefresh: true),
            onLoadMore: () => stockTseIfbNotifier.loadMore(),
            onInitialize: () => stockTseIfbNotifier.fetchInitialData(),
            assetType: AssetType.stock, // This might need to be more specific if StockPage uses this delegate
        );
        break;
      default:
  ...
  ThemeData appBarTheme(BuildContext context) {
    ...
    return theme.copyWith(
      appBarTheme: theme.appBarTheme.copyWith(
        ...
        elevation: 0,
        iconTheme: IconThemeData(color: isDarkMode ? Colors.white : Colors.black, size: 22),
        toolbarHeight: 44.0,
      ),
      scaffoldBackgroundColor: isDarkMode ? const Color(0xFF1C1C1E) : const Color(0xFFF2F2F7),
      dividerTheme: DividerThemeData(color: isDarkMode ? Colors.grey[800] : Colors.grey[300], thickness: 0.5, space: 0.5),
      textTheme: theme.textTheme.copyWith(
        titleLarge: TextStyle(fontFamily: 'SF-Pro', fontWeight: FontWeight.w600, color: isDarkMode ? Colors.white : Colors.black, fontSize: 17),
        bodyMedium: TextStyle(fontFamily: 'SF-Pro', color: isDarkMode ? Colors.white : Colors.black, fontSize: 16),
      ),
