...
class TermsAndConditionsScreen extends StatelessWidget { // Changed to StatelessWidget
  const TermsAndConditionsScreen({super.key});

  @override
  Widget build(BuildContext context) { // WidgetRef removed
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Builder( // Use Builder to handle different states from TermsNotifier
          builder: (context) {
            if (termsNotifier.isLoading) {
              return const Center(child: CupertinoActivityIndicator());
            }
            if (termsNotifier.error != null || termsNotifier.termsData == null) {
              return Center(
                child: Text(
                          ...
                          Align(
                            ...
                            child: GestureDetector(
                              ...
                              child: Padding(
                                ...
                                child: Icon(
                                  isFa ? CupertinoIcons.chevron_right : CupertinoIcons.chevron_left,
                                  size: 24,
                          ...
                          children: [
                            ...
                            if (terms.lastUpdated.isNotEmpty)
                              Padding(
                                ...
                                child: Center(
                                  child: Text(
                                    isFa ? 'آخرین بروزرسانی: ${terms.lastUpdated}' : 'Last updated: ${terms.lastUpdated}',
                                    style: TextStyle(
                                      fontFamily: isFa ? 'Vazirmatn' : 'SF-Pro',
                                      fontSize: 12,
                                      color: fadedTextColor,
